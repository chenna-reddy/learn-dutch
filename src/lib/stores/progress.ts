...
function mapDoc(id: string, data: any): StoryProgress {
  return {
    ...
    averageScore:
      typeof data?.averageScore === "number" ? data.averageScore : undefined,
...
async function upsert(
  ...
  if (merged.fluencyLevel !== undefined)
    payload.fluencyLevel = merged.fluencyLevel;
  if (merged.averageScore !== undefined)
    payload.averageScore = merged.averageScore;
  try {
